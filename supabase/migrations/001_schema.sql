-- Schema para o App de Gestão de Vacinas
...
CREATE INDEX idx_records_child ON vaccine_records(child_id);
CREATE INDEX idx_records_status ON vaccine_records(status);
CREATE INDEX idx_vaccine_types_custom ON vaccine_types(is_custom);
